...
import assessorImage from "@/assets/assessor-property-entry.webp";
      ...
      <div className="container-section">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center max-w-6xl mx-auto">
          ...
          <div className="order-2 lg:order-1">
            <div className="rounded-xl overflow-hidden shadow-card-hover aspect-[3/4] max-w-md mx-auto lg:mx-0">
              <img
                src={assessorImage}
                alt="Rick from Solent EPC arriving on site to carry out an energy assessment"
